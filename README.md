...
<p align="justify">
  <b>Gulir dan pilih penjelasan atau panduan folder yang anda cari(masih dalam tahap pengembangaan)</b> , di bawah ini untuk melihat panduan teknis . Sebagian besar materi pemrograman kompetitif dalam repositori ini diambil langsung dari soal-soal latihan pada platform TLX (https://tlx.toki.id/courses).
</p>
